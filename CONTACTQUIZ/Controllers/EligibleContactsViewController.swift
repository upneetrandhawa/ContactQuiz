//
//  EligibleContactsViewController.swift
//  PHONEQUIZ
//
...
class EligibleContactsViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout, UISearchBarDelegate{
    ...
    let contactInfoCellIdentifier = "contactInfoCell"
    ...
    override func viewDidLoad() {
        ...
        if let _user = user {
            allContactsDict = _user.allContactsDict
            eligibleContactsDict = _user.eligibleContactsDict
            nonEligibleContactsDict = _user.nonEligibleContactsDict
        }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: contactsCellIdentifier, for: indexPath) as! ContactsCollectionViewCell
